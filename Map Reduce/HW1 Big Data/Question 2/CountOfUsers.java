 ...
 * Net Id: svs130130
 * Description: Q2 Find the count of female and males users in each 
 * age group.
 ******************************************************************************/
...
public class CountOfUsers {
	...
	public static class Map extends
		...
		public void map(LongWritable key, Text value, Context context)
			...
			String age_gender = split_str[2] + " " + split_str[1];
			Text ag = new Text(age_gender);
			
			context.write(ag, one);
		}
	}
